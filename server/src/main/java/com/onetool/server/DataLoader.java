...
public class DataLoader implements CommandLineRunner {
    ...
    private void loadDiabetes() {
        saveDiabetesIfNotExists(
                ...
                "https://i.ibb.co/DCL0tbw/image.png",
                "500",
                "200",
                "냉장"
        );
        saveDiabetesIfNotExists(
                ...
                "https://i.ibb.co/7v5JKVq/image.png",
                "252",
                "330",
                "냉장"
        );
        saveDiabetesIfNotExists(
                ...
                "https://i.ibb.co/PzDsyrD/image.png",
                "267",
                "355",
                "냉장"
        );
        ...
        saveDiabetesIfNotExists(
                ...
                "https://image.greating.co.kr/IL/item/202310/11/B_3780A886A0694FC18BA8638036FD07A8.jpg",
                "https://i.ibb.co/SyZV5xK/image.png",
                "267",
                "355",
                "냉장"
        );
        saveDiabetesIfNotExists(
                ...
                "https://i.ibb.co/FWWndYR/image.png",
                "262",
                "290",
                "냉장"
        );
        ...
        saveDiabetesIfNotExists(
                ...
                "https://i.ibb.co/VtHjSsk/image.png",
                "549",
                "465",
                "냉동"
        );
        ...
        saveDiabetesIfNotExists(
                ...
                "https://image.greating.co.kr/IL/item/202401/26/M_2894F93EDFEE4C94B9F6A14A29AB5881.jpg",
                "https://i.ibb.co/rxtmPc7/image.png",
                "360",
                "325",
                "냉장"
        );
        ...
        saveDiabetesIfNotExists(
                ...
                "https://i.ibb.co/WxT7jmY/image.png",
                "287",
                "330",
                "냉장"
        );
        ...
        saveDiabetesIfNotExists(
                ...
                "https://i.ibb.co/qrBpFC4/image.png",
                "273",
                "315",
                "냉장"
        );
        saveDiabetesIfNotExists(
                ...
                "https://i.ibb.co/tKyC6f6/image.png",
                "282",
                "300",
                "냉장"
        );
